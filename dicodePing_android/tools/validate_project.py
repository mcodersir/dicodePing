...
if 'versionName = "2.0.2"' not in build_file:
    errors.append("versionName must be 2.0.2 for this release")
if 'buildConfigField("String", "RELEASE_VERSION", "\\"2.0.2\\"")' not in build_file:
    errors.append("RELEASE_VERSION must be 2.0.2 for this release")
...
if not re.search(r"^\s*versionCode\s*=\s*58\s*$", build_file, re.MULTILINE):
    errors.append("Android 2.0.2 Stable versionCode must be 58")
