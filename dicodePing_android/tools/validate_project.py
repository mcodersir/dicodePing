...
if 'versionName = "1.9.0-rc.11"' not in build_file:
    errors.append("versionName must be 1.9.0-rc.11 for this release")
if 'buildConfigField("String", "RELEASE_VERSION", "\\"1.9.0-rc.11\\"")' not in build_file:
    errors.append("RELEASE_VERSION must be 1.9.0-rc.11 for this release")

if "compileSdk = 36" not in build_file or "targetSdk = 36" not in build_file:
    errors.append("Android RC11 must compile and target API 36")
...
if "versionCode = 45" not in build_file:
    errors.append("Android RC11 versionCode must be 44")
