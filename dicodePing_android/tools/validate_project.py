...
if 'versionName = "1.8.0-rc.4"' not in build_file:
    errors.append("versionName must be 1.8.0-rc.4 for this release")
if 'buildConfigField("String", "RELEASE_VERSION", "\\"1.8.0-rc.4\\"")' not in build_file:
    errors.append("RELEASE_VERSION must be 1.8.0-rc.4 for this release")
