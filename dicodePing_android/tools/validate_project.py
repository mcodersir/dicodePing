...
if 'versionName = "1.9.0-rc.7"' not in build_file:
    errors.append("versionName must be 1.9.0-rc.7 for this release")
if 'buildConfigField("String", "RELEASE_VERSION", "\\"1.9.0-rc.7\\"")' not in build_file:
    errors.append("RELEASE_VERSION must be 1.9.0-rc.7 for this release")

if "compileSdk = 36" not in build_file or "targetSdk = 36" not in build_file:
    errors.append("Android RC7 must compile and target API 36")
...
if "versionCode = 42" not in build_file:
    errors.append("Android RC7 versionCode must be 42")
