...
:build
call gradlew.bat --no-daemon --warning-mode=fail clean testStandardDebugUnitTest lintStandardRelease assembleStandardRelease
if errorlevel 1 exit /b 1
...
if errorlevel 1 exit /b 1
py -3 tools\verify_apk_fonts.py "release\dicodePing-v%VERSION%-android.apk"
if errorlevel 1 exit /b 1
