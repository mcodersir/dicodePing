dicodePing v1.9.0-rc.19 for Linux x86_64
...
----------------------------
مسیر اتصال RC19 یک VPN کامل مبتنی بر TUN است:
...
RC19 uses full-device TUN routing, not desktop proxy settings. Before it
