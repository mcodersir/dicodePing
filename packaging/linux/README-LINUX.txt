dicodePing v1.9.0-rc.18 for Linux x86_64
...
----------------------------
مسیر اتصال RC18 یک VPN کامل مبتنی بر TUN است:
...
RC18 uses full-device TUN routing, not desktop proxy settings. Before it
