dicodePing Version 3 pre-release (3.0.0-pre.1)
...
System-proxy/TUN modes may require desktop-session or elevated networking permissions depending on the distribution.
