...
set "COMMIT_MESSAGE=release: publish dicodePing v2.0.1 stable"
set "SOURCE_DIR=%CD%"
...
if not exist "docs\releases\v2.0.1.md" goto :missing_source
if not exist "docs\site\index.html" goto :missing_source
if not exist "app_v200.py" goto :missing_source
if not exist "tests\test_v201_stable.py" goto :missing_source
if not exist "tools\validate_v201_stable.py" goto :missing_source
...
if not exist "tests\test_v201_stable.py" (popd & goto :cleanup_failed)
if not exist "tools\validate_v201_stable.py" (popd & goto :cleanup_failed)
findstr /C:"versionCode = 57" "dicodePing_android\app\build.gradle.kts" >nul || (popd & goto :cleanup_failed)
...
if errorlevel 1 goto :validation_failed
call %PYTHON_CMD% tools\validate_v201_stable.py
if errorlevel 1 goto :validation_failed
