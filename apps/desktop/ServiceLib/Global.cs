...
public class Global
{
    ...
    public const string AutoRunName = "DicodePingAutoRun";
    ...
    public const string AvaAssets = "avares://DicodePing/Assets/";
    public const string LocalAppData = "DICODEPING_LOCAL_APPLICATION_DATA";
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.v2rayN, "mcodersir/dicodePing" },
    };
