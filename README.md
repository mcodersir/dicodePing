...
برای اجرای اتصال، فایل Xray سازگار با سیستم را در `bin/xray` (در Windows: `bin/xray.exe`) قرار دهید. بسته‌های Release این runtime را خودکار همراه دارند. اجرای TUN به دسترسی Administrator نیاز دارد.
