...
require("dicodeping/__init__.py", '__version__ = "3.0.0-pre.6"')
require("tools/windows_version_info.txt", "3.0.0.0", "3.0.0-pre.6")
...
for marker in (
    "dicodePing-v3.0.0-pre.6-windows-x64.exe",
    "dicodePing-v3.0.0-pre.6-linux-x86_64.tar.gz",
    "dicodePing-v3.0.0-pre.6-macos-arm64.dmg",
    "dicodePing-v3.0.0-pre.6-macos-x86_64.dmg",
...
require("runtime_assets/RUNTIME_ASSETS.lock.json", '"release": "3.0.0-pre.6"', '"Xray-windows-64.zip"', '"runtime_version": "26.7.11"')
...
if release_docs != ["v3.0.0-pre.6.md"]:
...
if errors:
    print("dicodePing 3.0.0-pre.6 validation failed:", file=sys.stderr)
    for error in errors:
        print(f"- {error}", file=sys.stderr)
    raise SystemExit(1)
print("dicodePing 3.0.0-pre.6 source validation passed")
