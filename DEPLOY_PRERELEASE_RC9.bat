...
chcp 65001 >nul
title dicodePing v1.9.0 RC9 - Release Recovery Deploy
cd /d "%~dp0"
...
set "COMMIT_MESSAGE=release: recover and publish v1.9.0-rc.9 prerelease"
set "SOURCE_DIR=%CD%"
...
cls
echo ================================================================
echo      dicodePing v1.9.0 RC9 - Release Recovery Deploy
echo ================================================================
echo.
...
echo   3. Copy and validate the fixed RC9 source.
