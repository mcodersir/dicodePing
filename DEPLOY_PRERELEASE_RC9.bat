...
chcp 65001 >nul
title dicodePing v1.9.0 RC9 Hotfix 2 - Release Recovery Deploy
cd /d "%~dp0"
...
set "COMMIT_MESSAGE=fix: publish v1.9.0-rc.9 Android scanner hotfix 2"
set "SOURCE_DIR=%CD%"
...
cls
echo ================================================================
echo      dicodePing v1.9.0 RC9 Hotfix 2 - Release Recovery Deploy
echo ================================================================
echo.
...
echo   3. Copy and validate the RC9 Hotfix 2 source.
