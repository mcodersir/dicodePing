...
class V160Rc3Tests(unittest.TestCase):
    def test_version_bumped_to_rc3(self) -> None:
        ...
        self.assertIn('RELEASE_VERSION = "1.9.0-rc.11"', constants)
        self.assertIn('versionCode = 46', gradle)
        self.assertIn('versionName = "1.9.0-rc.11"', gradle)
        self.assertIn('RC_VERSION = "rc.11"', linux_builder)
    ...
    def test_scanner_is_staged_with_stop_and_alive_count(self) -> None:
        ...
        self.assertIn("DEFAULT_RANK1_PER_CHANNEL = 8", scanner)
        self.assertIn("DEFAULT_RANK2_PER_CHANNEL = 9", scanner)
