...
def test_android_release_version_is_rc18_and_install_is_forced_by_version_code() -> None:
    ...
    assert 'buildConfigField("String", "RELEASE_VERSION", "\\"1.9.0-rc.18\\"")' in gradle
...
def test_rc18_deploy_and_local_apk_build_purge_stale_tethering_class() -> None:
