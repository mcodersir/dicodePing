"""v2rayN-based service layer for dicodePing Version 3.

Provides server service operations including build_and_save,
refresh_saved, and auto_candidates for the v2rayN stack.
"""
...
from dicodeping.geo import GeoResolver
from dicodeping.i18n import tr
from .models import DiscoveredConfig, ServerRecord, utc_now
from dicodeping.net import ping_many
from dicodeping.resource_tuning import current_resource_profile
...
FAILURE_PENALTY_MS = 80
RECENT_CONNECT_BONUS_MS = 30
UNKNOWN_COUNTRY_PENALTY_MS = 120
...
def _has_trusted_location(server):
    return (
...
class ServerService:
    ...
    def refresh_saved(
        ...
        self.store.save_servers(records)
        try:
            from dicodeping import ping_cache
