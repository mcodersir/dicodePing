# گزارش اصلاح انتشار و GitHub Pages — RC17

## علت متوقف‌شدن انتشار

فایل‌های تست RC15 در پوشه‌ای که RC17 روی آن Extract شده بود باقی مانده بودند. این تست‌ها عمداً انتظار نسخه، `versionCode`، Entry Point و فایل Deploy مربوط به RC15 را داشتند و پیش‌اعتبارسنجی RC17 را متوقف می‌کردند.
...
- وضعیت اتصال دسکتاپ تنها با متن لاگ تعیین نمی‌شود؛ آماده‌شدن SOCKS و عبور Probe واقعی شرط اتصال است و Stop مالک پردازش را لغو و پورت را آزاد می‌کند.
